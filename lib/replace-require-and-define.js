...
const eswalk = require('esprima-walk').walkAddParent;
    ...
    switch (node.type) {
      case 'CallExpression':
        ...
        if (node.callee.name === 'define') {
          ...
          if (node.arguments.length < 2 || node.arguments[1].type !== 'ArrayExpression' || !node.arguments[1].elements || node.callee.type === 'MemberExpression') {
            return;
          }
